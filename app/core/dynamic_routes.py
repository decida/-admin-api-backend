"""
Resource execution logic for API Resources.

This module contains the core logic for executing API resources,
supporting both single business object execution and chain execution.
"""
...
async def execute_dynamic_endpoint_logic(
    ...
    # 5. Fetch connection (accepts both ID and slug)
    try:
